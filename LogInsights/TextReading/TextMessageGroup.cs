        ...
        public void AppendMessage(TextMessage msg)
        {
            ...
            bool msgBelongsToGroup = bufferLevel == 0 //this is the very first msg in this group
                                     || (
                                        ...
                                        buffer[bufferLevel - 1].textLocator.messageNumber + 10 >= msg.textLocator.messageNumber &&   //we allow a gap of 10 messages, we cannot infinitely wait for group closure
